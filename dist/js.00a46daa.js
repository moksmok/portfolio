...
tl.to('.title-scroll', {
  ...
  x: 0,
  opacity: 1
}, '-=0.9'); //          IF USER CLICK BACK, HIDE PROJECT CARD
...
function afterPreload() {
  ...
  $('#pagepiling').pagepiling((_$$pagepiling = {
    menu: null,
    direction: 'vertical',
    ...
    css3: false,
    navigation: false
  }, _defineProperty(_$$pagepiling, "navigation", {
    'textColor': '#000',
    'bulletsColor': '#15e7c0',
    'position': 'right'
  }), _defineProperty(_$$pagepiling, "normalScrollElements", null), _defineProperty(_$$pagepiling, "normalScrollElementTouchThreshold", 3), _defineProperty(_$$pagepiling, "touchSensitivity", 5), _defineProperty(_$$pagepiling, "keyboardScrolling", true), _defineProperty(_$$pagepiling, "sectionSelector", '.section'), _defineProperty(_$$pagepiling, "animateAnchor", false), _defineProperty(_$$pagepiling, "onLeave", function onLeave(index) {
    if (index == 1) {
      console.log('lecimy');
      gsap.to('.main-title', {
        duration: 0.3,
  ...
  }), _defineProperty(_$$pagepiling, "afterLoad", function afterLoad(anchorLink) {
    if (anchorLink == 'home') {
      console.log('hooome');
      tl.restart(); // gsap.to('.main-title', {duration: 0.3, y: 0, opacity: 1},  )
  ...
  }), _defineProperty(_$$pagepiling, "afterRender", function afterRender() {
